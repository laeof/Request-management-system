    ...
    public partial class _initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, null, null, null, new DateTime(2023, 7, 14, 10, 5, 58, 151, DateTimeKind.Utc).AddTicks(9594) },
                    { 2L, null, null, null, new DateTime(2023, 7, 14, 10, 5, 58, 151, DateTimeKind.Utc).AddTicks(9603) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "Comment", "Max", "../../img/jpg/preview.jpg", true, "ADMIN", "$HASH|V1$10000$P4AV9lN9ufaxr+/TATZxniiy7hS0Kpe9r2vo8R8O6dxRBONI", "Akchurin" },
                    { 2L, "Comment", "Anton", "../../img/Avatar/user.png", true, "MANAGER", "$HASH|V1$10000$FSWYaCCAZKbiH7wIk7Z9Cu+KSlDlhO3NGNiWwGsG/ANX/Xqc", "Guryshkin" },
                    { 3L, "Comment", "Georgii", "../../img/Avatar/user.png", true, "mounter", "$HASH|V1$10000$5Mpv3n/SnqFvb40XN10xPV6FUM9PKVJS84kLfw1yiiMBAi1K", "Perepelitsa" }
                });
