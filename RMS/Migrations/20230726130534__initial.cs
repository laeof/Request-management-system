    ...
    public partial class _initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, null, null, null, new DateTime(2023, 7, 26, 13, 5, 34, 612, DateTimeKind.Utc).AddTicks(8263) },
                    { 2L, null, null, null, new DateTime(2023, 7, 26, 13, 5, 34, 612, DateTimeKind.Utc).AddTicks(8269) }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "ApiKey", "Comment", "FirstName", "ImgPath", "IsActive", "IsDeleted", "Login", "Password", "Surname", "WorkHours" },
                values: new object[,]
                {
                    { 1L, "xd", "Comment", "Max", "../../img/jpg/preview.jpg", true, false, "ADMIN", "$HASH|V1$10000$C49wZe9P94PHOI2kGvfStlQYWkzvsIBnYh+5sUeu77rr3Uhr", "Admin", null },
                    { 2L, null, "Comment", "Anton", "../../img/Avatar/user.png", true, false, "MANAGER", "$HASH|V1$10000$97oMPpQD2+ZLsx1F9ZK0oRgyh+sdnkNaDFQrWRxI7exANcTx", "Manager", null },
                    { 3L, null, "Comment", "Georgii", "../../img/Avatar/user.png", true, false, "mounter", "$HASH|V1$10000$UD7JtOEC//3gJCCESAi+5lPQsWtdQbY487a58I0AxpdGm6Ig", "Mounter", null }
                });
