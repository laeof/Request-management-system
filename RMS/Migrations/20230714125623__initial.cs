    ...
    public partial class _initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, null, null, null, new DateTime(2023, 7, 14, 12, 56, 23, 22, DateTimeKind.Utc).AddTicks(2607) },
                    { 2L, null, null, null, new DateTime(2023, 7, 14, 12, 56, 23, 22, DateTimeKind.Utc).AddTicks(2615) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "Comment", "Max", "../../img/jpg/preview.jpg", true, false, "ADMIN", "$HASH|V1$10000$zcy8cfPnAXiw79GzzZgcF5bEqAFE9kc5Q816P2jjHXsXopg+", "Akchurin" },
                    { 2L, "Comment", "Anton", "../../img/Avatar/user.png", true, false, "MANAGER", "$HASH|V1$10000$D0eaXRZmAzs2QFkFO2W2TVJtgoZG2DkqG4DRq+WEuZ2enXPU", "Guryshkin" },
                    { 3L, "Comment", "Georgii", "../../img/Avatar/user.png", true, false, "mounter", "$HASH|V1$10000$M+lxPKxnvcVlTVGokEolqN52/tYlMTO41kSFKvFuJY1VF3Ht", "Perepelitsa" }
                });
