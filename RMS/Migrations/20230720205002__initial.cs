    ...
    public partial class _initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, null, null, null, new DateTime(2023, 7, 20, 20, 50, 2, 843, DateTimeKind.Utc).AddTicks(7862) },
                    { 2L, null, null, null, new DateTime(2023, 7, 20, 20, 50, 2, 843, DateTimeKind.Utc).AddTicks(7871) }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Comment", "FirstName", "ImgPath", "IsActive", "IsDeleted", "Login", "Password", "Surname" },
                values: new object[,]
                {
                    { 1L, "Comment", "Max", "../../img/jpg/preview.jpg", true, false, "ADMIN", "$HASH|V1$10000$44Oc0ZT6zyXzeesVBkAAEV4h9L8N4Vqs0XTG5byA5hPCzvRg", "Akchurin" },
                    { 2L, "Comment", "Anton", "../../img/Avatar/user.png", true, false, "MANAGER", "$HASH|V1$10000$hNlw2dGyBl8/FPk6Dc95XfbKU6vKUrue6FM0z+5w7UVOhWpB", "Guryshkin" },
                    { 3L, "Comment", "Georgii", "../../img/Avatar/user.png", true, false, "mounter", "$HASH|V1$10000$0h2V0WY2QapCCk9uAom3qZ8Y/IwSg2v4n+SFt7b4QcO8qyh8", "Perepelitsa" }
                });
